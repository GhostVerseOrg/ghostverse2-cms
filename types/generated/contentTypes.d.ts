...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    CategoryColor: Attribute.Enumeration<['orange', 'green', 'purple']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    CategoryLabel: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    MinutesToRead: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationHeaderNavigationHeader extends Schema.SingleType {
  ...
  attributes: {
    MenuBody: Attribute.DynamicZone<['menu.dropdown', 'menu.link']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Schema.SingleType {
  ...
  attributes: {
    LegalContent: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
